...
{
    public class Import_FairValue_Measurement_Class : IWorksheetImport
    {
        ...
        public List<string> GetValidColumnNames()
        {
            ...
            validColumnNames.Add("FairValueMeasurementClass");
            validColumnNames.Add("FairValueMeasurementApproach");
            validColumnNames.Add("FairValueMeasurementHierarchy");
